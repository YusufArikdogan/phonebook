...
app.config['MYSQL_DATABASE_PASSWORD'] = 'Devops12'
...
# Write a function named `init_todo_db` create phonebook table within techproed_phonebook db, if it doesn't exist
